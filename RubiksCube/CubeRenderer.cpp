...
void CubeRenderer::Render(const glm::mat4& transformationMatrix)
{
...
void CubeRenderer::ClearResources()
{
...
void CubeRenderer::AddSidePosition(int sideType, int direction, std::vector<glm::vec3>& positionArray)
{
...
void CubeRenderer::AddSideColor(int sideType, int direction, std::vector<glm::vec3>& colorArray)
{
...
void CubeRenderer::TranscribeToFloatArray(std::vector<glm::vec3>& vecArray, float* floatArray)
{
